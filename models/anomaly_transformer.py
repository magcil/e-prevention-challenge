...
class RECHead(nn.Module):
    def __init__(self, in_dim, in_chans=1, patch_size=16):
        ...
        self.convTrans = nn.ConvTranspose2d(512, in_chans, kernel_size=(patch_size, patch_size), 
                                                stride=(8, 8))
    ...
    def forward(self, x):
        ...
        out_sz = tuple( (  1,3 ) )
        x_rec_unflattened = x_rec.unflatten(2, out_sz)
        x_rec = self.convTrans(x_rec_unflattened)
